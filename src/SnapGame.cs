...
namespace CardGames
{
    public class SnapGame
    {
		...
		private static void DrawGame(Snap myGame)
		{
			...
			SwinGame.DrawText(""+myGame.Score(0),Color.White,"GameFont",20,50);
			SwinGame.DrawText(""+myGame.Score(1),Color.White,"GameFont",820,50);
			...
			if (top != null)
			{
				...
				SwinGame.DrawText (""+myGame.Score(0), Color.RoyalBlue, "GameFont", 20,50);
				SwinGame.DrawText (""+myGame.Score(1), Color.RoyalBlue, "GameFont", 820,50);
